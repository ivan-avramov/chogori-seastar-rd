...
struct reactor_options : public program_options::option_group {
    ...
    /// \brief Enable the rdma stack with the specified rdma device name
    program_options::value<std::string> rdma;
    /// \brief Specify RDMA GID index to use (default 3)
    program_options::value<unsigned> rdma_gid;
